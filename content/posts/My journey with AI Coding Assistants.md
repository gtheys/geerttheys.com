...
description = 'A developers honest journey using AI coding assistants, exploring tools like AIDER and Claude, while sharing practical insights about their limitations and game-changing potential in software development.'
date = 2025-01-17
draft = false
authors = ["Geert Theys"]
featuredImage = '/images/conductor.jpg'
